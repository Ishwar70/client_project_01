...
const ExploreDestinations = () => {
  ...
  useEffect(() => {
    const fetchDestinations = async () => {
      try {
        setLoading(true);
        const res = await getAllDestinations({ search: "Goa", limit: 3 });
          ...
          {loading ? (
            ...
            >
              ...
              <div className="relative h-48 md:h-52 w-full overflow-hidden">
                <img 
                  src={dest.image?.url || 'https://images.unsplash.com/photo-1512757776214-26d36777b513?q=80&w=800'} 
                  alt={dest.name} 
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="mb-4">
                  ...
                  <p className="text-[10px] text-gray-400 font-medium italic mt-1">
                    {dest.experience || "A vibrant coastal experience"}
                  </p>
                </div>
