...
const packages = [
  {
    id: 1,
    name: "Mystic Mussoorie & Dhanaulti",
    price: "8,999",
    duration: "2N/3D",
  ...
  },
  {
    ...
    price: "7,499",
    duration: "2N/3D",
    image: "https://images.unsplash.com/photo-1598971861713-54ad16a7e72e?q=80&w=800",
  },
  {
    id: 3,
    name: "Nainital Lake Magic",
    price: "9,299",
    duration: "2N/3D",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQVf18RlchldHfsU5izKTM3-VMUJBOhb1P3aA&s",
  }
];
    ...
    <section className="py-10 bg-white font-sans">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {packages.map((pkg) => (
            <div key={pkg.id} className="group relative bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:border-[#D4AF37]/30 transition-all duration-500">
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full shadow-lg">
                  <p className="text-[10px] font-black text-gray-900 uppercase tracking-tighter">{pkg.duration}</p>
                </div>
              </div>

              {/* Package Details */}
              <div className="p-6">
                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-[#D4AF37] transition-colors">{pkg.name}</h3>
                
                <div className="flex items-baseline gap-1 mb-6">
                  <span className="text-gray-500 text-xs font-medium uppercase">Starting at</span>
                  <span className="text-2xl font-black text-[#D4AF37]">₹{pkg.price}</span>
