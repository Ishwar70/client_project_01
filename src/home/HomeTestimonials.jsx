...
export default function HomeTestimonials() {
  return (
    <section style={{ background: WHITE }} className="w-full px-4 sm:px-8 md:px-16 lg:px-24 py-16 md:py-20">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold" style={{ fontFamily: "'Georgia', serif" }}>
            <span style={{ color: DARK_TEXT }}>What Our </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {reviews.map((r) => (
            <div
              ...
              style={{ border: `1px solid ${GOLD}40` }} // Subtle gold border (40 is alpha)
            >
              ...
              <p className="text-sm italic leading-relaxed mb-5" style={{ color: DARK_TEXT }}>
                "{r.quote}"
              </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs font-semibold" style={{ color: DARK_TEXT }}>{r.name}</p>
